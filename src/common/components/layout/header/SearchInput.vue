...
<template>
  <div class="flex h-10 flex-1 overflow-hidden rounded-lg border border-gray-200">
    ...
    <button class="cursor-pointer whitespace-nowrap border-none bg-primary px-6 text-base text-white transition-colors hover:bg-blue-500 active:bg-blue-600">{{ $t('header.searchButton') }}</button>
  </div>
</template>
